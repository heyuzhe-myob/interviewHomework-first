...
public class SampleApp {
    public static void main(String[] args) {
        Product product1 = new Product(10.0, "DIS_10_PRODUCT1", "product 1", 1);
        Product product2 = new Product(20.0, "DIS_10_PRODUCT2", "product 2", 1);
        ...
        Product product3 = new Product(30.0, "DIS_10_PRODUCT3", "product 3", 1);
